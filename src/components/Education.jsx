...
const FeatureCard = ({
  ...
  >
    ...
    <div className="flex-1 flex flex-col ml-4">
      ...
      <p className="font-poppins font-normal text-dimWhite text-[14px] leading-[30px] mb-1 break-words">
        {duration}
      </p>
      <p className="font-poppins font-normal text-dimWhite text-[16px] leading-[30px] mb-1 break-words text-justify">
        ● {content1}
      </p>
      {content2 && (
        <p className="font-poppins font-normal text-dimWhite text-[16px] leading-[30px] mb-1 break-words text-justify">
